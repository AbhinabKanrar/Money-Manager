...
public interface CommonConstant {
	...
	String KEY_TOTAL_CUSTOMER = "TOTAL_CUSTOMER";
	String KEY_TOTAL_ASSIGNED_CUSTOMER = "TOTAL_ASSIGNED_CUSTOMER";
	String KEY_TOTAL_UNASSIGNED_CUSTOMER = "TOTAL_UNASSIGNED_CUSTOMER";
